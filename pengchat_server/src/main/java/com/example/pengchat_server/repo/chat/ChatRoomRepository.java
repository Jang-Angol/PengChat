...
import com.example.pengchat_server.controller.chat.ChatRoom;
...
public class ChatRoomRepository {
    ...
    private final RedisMessageListenerContainer redisMessageListenr;
    // 구독 처리 서비스
    ...
    * */
    public void enterChatRoom(String roomId){
        ...
        if (topic == null){
            ...
            redisMessageListenr.addMessageListener(redisSubscriber, topic);
